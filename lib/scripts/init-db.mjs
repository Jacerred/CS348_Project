...
db.exec(`
  ...
  CREATE INDEX IF NOT EXISTS idx_shows_seller_id ON Shows(seller_id);
  CREATE INDEX IF NOT EXISTS idx_shows_category_id ON Shows(category_id);
  CREATE INDEX IF NOT EXISTS idx_gs_show_id ON GiveawayState(show_id);

  -- 2. Index columns used in WHERE range filters
  CREATE INDEX IF NOT EXISTS idx_shows_viewer_count ON Shows(viewer_count);
`);
